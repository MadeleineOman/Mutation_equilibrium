...
text_file = open("data/dif_DNA/{t}_DNA_gen0_cds.txt".format(t=NameForThisSim), "w")  #! need to change file creation: use the {}.format... file structure? 
n = text_file.write(DNA)
text_file.close()
text_file = open("data/dif_DNA/{t}_DNA_map_cds_invariant50.txt".format(t=NameForThisSim), "w")
n = text_file.write(DNA_map)
text_file.close()
text_file = open("data/dif_DNA/{t}_exon_insertion_dict.txt".format(t=NameForThisSim), "w")
n = text_file.write(json.dumps(exons_insertion_position_dict))
text_file.close()
text_file = open("data/dif_DNA/{t}_exons_toUseSeqeunce_dict.txt".format(t=NameForThisSim), "w")

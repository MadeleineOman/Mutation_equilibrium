...
text_file = open("Scripting_data_trial5_simple_noWeights_countMuts/{t}_DNA_gen0_cds.txt".format(t=NameForThisSim), "w")                                               #! need to change file creation: use the {}.format... file structure? 
...
file = open("Scripting_data_trial5_simple_noWeights_countMuts/DNA_final_{t}.txt".format(t=NameForThisSim), "w+")
file.write(DNA)
file.close()

text_file = open("Scripting_data_trial5_simple_noWeights_countMuts/Triplet_mut_counts_{t}.txt".format(t=NameForThisSim), "w+")

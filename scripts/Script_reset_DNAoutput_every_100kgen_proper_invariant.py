...
text_file = open("Scripting_data_trial2/2020_08_12_invariant_redo/{t}_DNA_gen0_cds.txt".format(t=NameForThisSim), "w")  #! need to change file creation: use the {}.format... file structure? 
n = text_file.write(DNA)
text_file.close()
text_file = open("Scripting_data_trial2/2020_08_12_invariant_redo/{t}_DNA_map_cds_invariant50.txt".format(t=NameForThisSim), "w")
n = text_file.write(DNA_map)
text_file.close()
text_file = open("Scripting_data_trial2/2020_08_12_invariant_redo/{t}_exon_insertion_dict.txt".format(t=NameForThisSim), "w")
n = text_file.write(json.dumps(exons_insertion_position_dict))
text_file.close()
text_file = open("Scripting_data_trial2/2020_08_12_invariant_redo/{t}_exons_toUseSeqeunce_dict.txt".format(t=NameForThisSim), "w")
...
#         intron_mut.append(intron_mutability(DNA_map, weights)) # AVERAGE MUTABILITY OF INTRON  
    ...
    if x in gens_for_output: 
        ...
        file = open("Scripting_data_trial2/2020_08_12_invariant_redo/{t}_DNA_final_cds_invariant50_{g}.txt".format(t=NameForThisSim, g=x), "w+")
        file.write(DNA)
        file.close()
